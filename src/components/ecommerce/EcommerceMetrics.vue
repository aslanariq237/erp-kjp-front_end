  ...
  <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
    ...
    >
      ...
      <div class="flex items-end justify-between mt-5">
        <div>
          <span class="text-sm text-gray-500 dark:text-gray-400">Inquiry</span>
    ...
    >
      ...
      <div class="flex items-end justify-between mt-5">
        <div>
          <span class="text-sm text-gray-500 dark:text-gray-400">Purchase Orders</span>
          <h4 class="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90">{{ purchaseorder}}</h4>
        </div>
    ...
    >
      ...
      <div class="flex items-end justify-between mt-5">
        <div>
          ...
          <h4 class="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90">{{ salesorder }}</h4>
        </div>
    ...
    >
      ...
      <div class="flex items-end justify-between mt-5">
        <div>
          ...
          <h4 class="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90">{{ invoice }}</h4>
        </div>
...
<script>
import { Inquiry, Invoice, PurchaseOrder, Quatations, SalesOrders } from '@/core/utils/url_api';
