...
const menuGroups = [
  {
    ...
    items: [
      ...
      }, 
      {
        ...
        icon: ListIcon,
        subItems: [
          { name: "Bank Account", path: "/form-elements", pro: false },
          { name: "Account Receivable", path: "/form-elements", pro: false },
          { name: "Account Payable", path: "/form-elements", pro: false },
          { name: "Laporan Keuangan", path: "/form-elements", pro: false },
