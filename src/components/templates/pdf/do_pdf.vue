    ...
    <div class="quotation p-20 text-">
        <div class="header flex justify-between items-center">
            ...
            <div class="address w-[60%] text-left">
                <p class="font-semibold text-2md text-green-600">PT.KHAHAYAN JAYA PERSADA</p>
                <p class="text-md">
        ...
        <div class="body">
            <div class="mt-3">
                <div class="title text-center">
                    <p class="text-2md font-semibold mt-2">DELIVERY ORDER</p>
                </div>
                <div class="flex justify-between items-center text-md mt-5">
                    <div class="left w-[40%]">
                    ...
                    <table class="min-w-full divide-y mt-4 divide-gray-100 shadow-sm border-gray-200 border">
                        <thead class="border">
                            <tr class="text-center">                                
                                ...
                                <th class="text-md px-3 py-2 font-semibold">Address</th>                                
                            </tr>
                        </thead>
                        <tbody class="bg-white dark:bg-gray-800">
                            <tr class="text-center border-b-2" v-for="(pro, index) in item.detail_do" :key="index">
                                ...
                                <td class="text-md px-3 py-2">{{ item.point.point }}</td>
                                <td class="text-md px-3 py-2">{{ item.point.alamat }}</td>                                
                            </tr>                            
                        </tbody>
                    </table>
                </div>
                <div class="flex justify-between mt-20">
                    ...
                    <div>                         
                        <p class="mb-2 text-md">Pengirim</p>                           
                        <div class="text-md mt-28">                            
                        </div>
                    </div>
                    <div>                         
                        <p class="mb-2 text-md">Penerima</p>                           
                        <div class="text-md mt-28">                            
                        </div>
                    </div>                    
                </div>
