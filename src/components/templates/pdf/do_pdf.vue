<template>
    <div class="quotation p-20 text-">
        <div class="header flex justify-between items-center">
            <div class="logo">
                <img :src="getImagePaths('KJP_Logo.png')" class="w-60 h-40">
            </div>
        ...
        <div class="body">
            <div class="mt-3">
                <div class="title text-center">
                    <p class="text-4xl font-semibold">DELIVERY ORDER</p>
                </div>
                <div class="flex justify-between">
                    ...
                    <div class="right">                        
                        ...
                        <div class="flex">
                            <p class="w-48">Delivery Order No </p>
                            <p>: {{ item.code_do}}</p>
                        </div>                        
                        <div class="flex">
                            <p class="w-48">Delivery Date </p>
                            <p>: {{ item.issue_at }}</p>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="min-w-full divide-y mt-4 divide-gray-100 shadow-sm border-gray-200 border">
                        ...
                        <tbody class="bg-white dark:bg-gray-800">
                            <tr class="text-center border-b-2" v-for="(pro, index) in item.detail_do" :key="index">
                                ...
                                <td class="text-xl px-3 py-2">SCBD 92</td>
                                <td class="text-xl px-3 py-2">Jln. Purposa 12 block b21</td>                                
                            </tr>                            
                        </tbody>
                    </table>
                </div>
