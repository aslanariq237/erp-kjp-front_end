        ...
        <div class="body">
            <div class="mt-3">
                <div class="title text-center">
                    <p class="text-4xl font-semibold mt-5" v-if="item.approved == 0">DRAFT PURCHASE ORDER JASA KIRIM</p>
                    <p class="text-4xl font-semibold mt-5" v-else>PURCHASE ORDER JASA KIRIM</p>
                </div>
                ...
                <div class="my-16">
                    <table class="min-w-full divide-y divide-gray-100 shadow-sm border-gray-200 border">
                        ...
                        <tbody class="bg-white dark:bg-gray-800">
                            <tr class="text-center border-b-2 text-xl" v-for="(pro, index) in item.detailjakir" :key="index">                                
                                <td class="text-xl px-3 py-2">{{ index+1}}</td>                                
                                <td class="text-xl px-3 py-2">{{ pro.product_name }}</td>
                                <td class="text-xl px-3 py-2">{{ pro.quantity }}</td>                                
                                <td class="text-xl px-3 py-2">{{ numberWithCommas(pro.price) }}</td>
                                <td class="text-xl px-3 py-2">{{ numberWithCommas(pro.quantity * pro.price) }}</td>
                            </tr>
                            <tr>
