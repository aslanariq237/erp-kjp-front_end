            ...
            <div class="mt-3">
                    ...
                    <table class="min-w-full divide-y divide-gray-100 shadow-sm border-gray-200 border">
                        <thead class="bg-gray-300">
                            <tr class="text-center text-2xl ">
                                <th class="px-3 py-2 text-2xl font-semibold border-b">Part Number</th>
                                <th class="px-3 py-2 text-2xl font-semibold border-b">Description</th>
                                <th class="px-3 py-2 text-2xl font-semibold border-b">Qty</th>
                                <th class="px-3 py-2 text-2xl font-semibold border-b">UOM</th>
                                <th class="px-3 py-2 text-2xl font-semibold border-b">
                                    Price
                                </th>
                                <th class="px-3 py-2 text-2xl font-semibold border-b">Amount</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white dark:bg-gray-800">
                            <tr class="text-center border-b-2 text-2xl" v-for="(pro, index) in item.detail_inv" :key="index">
                                ...
                                <td class="text-2xl px-3 py-2 border"></td>
                            </tr>
                        </tbody>
                    </table>
                    <div class="flex items-center justify-between">
                        ...
                        <table class="min-w-[50%]">
                            ...
                            <tr>
                                ...
                                <td class="px-3 py-2 whitespace-nowrap"></td>
                                <td class="px-3 py-2 whitespace-nowrap"></td>
                                <td class="text-2xl px-3 py-2 whitespace-nowrap border-gray-200 border-2">Invoice
                                    SubTotal</td>
                            ...
                            <tr>
                                ...
                                <td class="px-3 py-2 whitespace-nowrap"></td>
                                <td class="px-3 py-2 whitespace-nowrap"></td>
                                <td class="text-2xl px-3 py-2 whitespace-nowrap border-gray-200 border-2">PPN 11%</td>
                                <td class="text-2xl px-3 py-2 whitespace-nowrap border-gray-200 border-2">
                                    <div class="flex justify-between">
                                        <span>IDR. </span>
                                        <span>
                ...
                <div class="flex justify-between mt-12">
                    <div>
                        ...
                        <div v-else>
                            <p class="text-2xl">Warm Regards</p>
                            <div class="text-2xl mt-44">
