            ...
            <div class="mt-3">
                ...
                <div class="flex justify-between mt-5">
                    ...
                    <div class="right">
                        ...
                        <div class="flex">
                            <p class="w-48">Invoice No </p>
                            <p>: {{ item.code_invoice }}</p>
                        </div>
                        <div class="flex">
                            <p class="w-48">Invoice Date </p>
                            <p>: {{ item.issue_at }}</p>
                        </div>
                        <div class="flex">
                ...
                <div class="mt-5">
                    <table class="min-w-full divide-y divide-gray-100 shadow-sm border-gray-200 border">
                        ...
                        <tbody class="bg-white dark:bg-gray-800">
                            <tr class="text-center border-b-2" v-for="(pro, index) in item.detail_inv" :key="index">
