    ...
    <div class="container mx-auto px-6 py-4">
      ...
      <div class="flex justify-between items-center mb-6">
        <div class="breadcrumb">
          <h1 class="text-2xl font-bold text-gray-800 dark:text-white/90">Purchase Order Jasa Kirim</h1>
          <p class="text-gray-500 text-sm mt-1">SCM / Purchase Order Jasa Kirim</p>
        </div>
