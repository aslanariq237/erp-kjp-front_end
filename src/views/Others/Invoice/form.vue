      ...
      <Form @submit="onSubmit" class="container mx-auto px-6 py-4">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <FormGroup label="Delivery Order" :required="true" :error="rules.no" errorMessage="Purchase Order is required">
              <select name="id_so" id="id_so" v-model="id_do" class="rounded w-full" @change="SelectedDeliveryOrder(id_so)">
