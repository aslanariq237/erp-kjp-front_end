<template>
      ...
      <div class="container mx-auto px-6 py-4">
        ...
        <div class="flex justify-between items-center mb-6">
          <div class="breadcrumb">
            <h1 class="text-2xl font-bold text-gray-800">Faktur Pajak Management</h1>
            <p class="text-gray-500 text-sm mt-1">Master Data / Faktur Pajak</p>
          </div>
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                ...
                >
                  ...
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm font-medium text-gray-900">{{ code_so }}</div>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm font-medium text-gray-900">{{ code_do }}</div>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm font-medium text-gray-900">{{ customer }}</div>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm font-medium text-gray-900">{{ pn }}</div>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm font-medium text-gray-900">{{ barang }}</div>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const tableHeaders = [
        { key: 'code_po', label: 'Kode PO' },
        { key: 'code_so', label: 'Kode SO' },
        { key: 'code_do', label: 'Kode DO' },
