        ...
        <Form @submit="onSubmit">
            <div class="">
                <div class="flex justify-between items-center shadow-lg rounded-lg p-4">
                    ...
                    <div class="btn flex justify-between items-center gap-4 text-xl">
                        <RouterLink to="/asset"
                            class=" px-3 py-3 my-2bg-blue-500 rounded-md cursor-pointer">Cancel
                        </RouterLink>
                        <div class="btn">
                ...
                <div class="input shadow-lg rounded-4 shadow=md p-4 mt-4">                    
                        ...
                        <div class="flex justify-between gap-5 align-top mt-3">
                            <div class="name w-full">
                                ...
                                <input 
                                    ...
                                    name="quantity_asset"
                                    class="w-full rounded-md px-3 py-3 my-2" 
                                    placeholder="Masukkan quantity Asset"
                                    v-model="qty"
                                >
                                <div class="fv-plugins-message-container">
                                    <div class="fv-help-block">
                            ...
                            <div class="status w-full">
                                ...
                                <input 
                                    ...
                                    name="status_asset"
                                    class="w-full rounded-md px-3 py-3 my-2" 
                                    placeholder="Masukkan Status Asset"
                                    v-model="status">
                                <div class="fv-plugins-message-container">
                                    <div class="fv-help-block">
                                        <p class="text-red-400 text-md italic" 
                                        v-if="rules.status == true">
                                            Status is required
                                        </p>
                                    </div>
                                </div>
