        ...
        <Form @submit="onSubmit">
            <div class="">
                <div class="flex justify-between items-center shadow-lg rounded-lg p-4">
                    ...
                    <div class="btun flex justify-between items-center gap-4">
                        <div class="btn">
                            <RouterLink to="/product"
                                class="px-5 py-2 text-xl cursor-pointer">Cancel
                            </RouterLink>
                        </div>
                        <div class="btn">
                            <button type="submit" class="px-5 py-2 text-xl bg-green-400 rounded-md text-white">Submit</button>
                        </div>
                    </div>
                </div>                
                    ...
                    <div class="field mt-3 text-lg font-semibold">
                        ...
                        <div class="flex justify-between gap-5 align-top mt-3">
                            <div class="status w-full">
                                <label>status</label>
                                <input type="text" id="status" name="status" class="w-full rounded-md px-3 py-3 my-2"
                                    placeholder="Masukkan status" v-model="status">
                                <div class="fv-plugins-message-container">
                                    <div class="fv-help-block">
