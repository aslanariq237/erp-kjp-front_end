      ...
      <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div class="type">
          ...
          <div class="button text-white">
            <button class="p-2 px-4 border-blue-400 border-2 rounded-l-lg"
              :class="{ 'bg-blue-400 text-white': po_type === '', 'text-black': po_type !== '' }"
              @click="po_type = ''">
              All
            </button>
            <button class="p-2 px-4 border-blue-400 border-2"
              :class="{ 'bg-blue-400 text-white': po_type === 'internal', 'text-black': po_type !== 'internal' }"
              @click="po_type = 'internal'">
              Internal
            </button>

            <button class="p-2 px-4 border-blue-400 border-2"
              :class="{ 'bg-blue-400 text-white': po_type === 'eksternal', 'text-black': po_type !== 'eksternal' }"
              @click="po_type = 'eksternal'">
              External
            </button>

            <button class="p-2 px-4 rounded-r-lg border-blue-400 border-2"
              :class="{ 'bg-blue-400 text-white': po_type === 'cogs', 'text-black': po_type !== 'cogs' }"
              @click="po_type = 'cogs'">
              Cogs
            </button>
          </div>
