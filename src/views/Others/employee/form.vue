        ...
        <Form @submit="onSubmit">
            <div class="">
                <div class="flex justify-between items-center shadow-lg rounded-lg p-4">
                    ...
                    <div class="btn flex justify-between items-center gap-5">
                        <div class="btn">
                            <RouterLink to="/employee" class="px-5 py-2 text-xl cursor-pointer ">Cancel</RouterLink>
                        </div>
                        <div class="btn">
                            <button type="submit" class="text-xl bg-green-400 px-5 py-2 rounded-md text-white">Submit</button>
                        </div>
                    </div>
                </div>                
                <div class="input shadow-lg rounded-lg p-4 mt-4">
                        ...
                        <div class="flex justify-between align-top gap-5">
                            ...
                            <div class="employee-phone w-full">
                                ...
                                <div class="fv-plugins-message-container">
                                    <div class="fv-help-block">
                                        <p class="text-red-400 text-md italic" 
                                        v-if="rules.employee_phone == true">
                        ...
                        <div class="flex justify-between gap-5 align-top mt-3">
                            <div class="employee-email w-full">
                                ...
                                <div class="fv-plugins-message-container">
                                    <div class="fv-help-block">
                                        <p class="text-red-400 text-md italic" 
                                        v-if="rules.employee_email == true">
