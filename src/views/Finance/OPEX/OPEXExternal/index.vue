        ...
        <div class="container mx-auto px-6 py-4">
            ...
            <div class="flex justify-between items-center mb-6">
                <div class="breadcrumb">
                    <h1 class="text-2xl font-bold text-gray-800">OPEX External</h1>
                    <p class="text-gray-500 text-sm mt-1">Finance Tools / Opex External</p>
                </div>
                <div class="flex gap-3">
                    ...
                    <RouterLink to="/opex-external/form"
...
export default defineComponent({
    ...
    methods: {
        ...
        editOpex(opex) {
            this.router.push('/opex-external/edit/' + opex.opex_id)
        },
        confirmDelete(opex) {
